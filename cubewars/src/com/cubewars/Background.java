...
public class Background extends GameObject
{
	 ...
	 * 
	 * @param file El nombre del fichero, con extensión, que aloja la imagen del Background.
	 */
	public Background (String file)
	{
		super (priority, new Texture (Gdx.files.internal ("media/backgrounds/" + file)), 0, 0);
	}
}