 ...
 * 
 * The turn controller remembers if a player has already made an attack or a movement, so only one action of each kind can be executed in the same turn. 
 * @author pyrosphere3
 *
 */
public class TurnController
{
	...
	/**
	 * Tells the turn controller that a specific player has executed a movement, so no forward actions of this kind can be done in this turn.
	 * @param p
	 */
	...
	/**
	 * Tells the turn controller that a specific player has executed an attack, so no forward actions of this kind can be done in this turn.
	 * @param p
	 */
	 ...
	 * @param p The player.
	 * @return True if the player can make a movement (has not made it yet) or false in any other case.
	 */
