...
public class Coordinates
{
	 ...
	 * 
	 * Creates an instance of Coordinates with the values provided by a {@link Pixel} object, calculating the cell value in which that {@link Pixel} is located automatically.
	 * 
	 ...
	 * 
	 * By definition, due to the fact that a single cell may contain lots of pixels, the Pixel returned will be the one located at the bottom-left of the current cell, following the same reference framework as the Window to ease the task of locating objects in the screen.
	 * 
