...
/**
 * A generic character in the game. This class has the common attributes to all players characters in the game grid: health, attack distance, movement distance, etc.
 * 
 * @author pyrosphere3
 */
public abstract class Character extends GameObject
{
	 ...
	 * @param maxHealth Maxmimum health points this character can have at any given time: <code>health &lt;= maxHealth</code>.
	 */
	...
	public void addDamage (float damage)
	{
		...
		if (health <= 0)
			System.out.println ("[CHARA] " + this.toString () + " is dead.");
	}

	/**
	 * Add health to this character. 
	 * 
	 * The amount of health points can never be grater than the maximum health points for this character class, and the amount of health added must be greater or equal to 0.
	...
	{
		if (health < 0)
			throw new IllegalArgumentException ("Cannot increase health with a negatuve number.");
