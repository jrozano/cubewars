 ...
 * A game object.
 * 
 * This is an abstract class that it's used as a base to implement other object classes used in the game.
 * 
 * @author Jesús Rozano
 */
public abstract class GameObject implements Comparable<GameObject>
{
	...
	{
		/*
		 * FIXME Given a large number of objects created and destroyed, the IDs are not reused. Possible overflow?
		 */
		GameObject.nextID++;
	 ...
	 * 
	 * This method implements the {@link Comparable}, needed to be able to use generic sort with {@link java.util.Collections#sort}. Compares <code>this</code> element with another <code>GameObject</code> g passed as a parameter.
	 * 
